...
namespace Sandbox.Game.Gui
{
    ...
    public class CEGuiScreenLoading : MyGuiScreenBase
    {
        //We have to ensure there is always only one loading screen instance
        public static CEGuiScreenLoading Static;
        ...
        public CEGuiScreenLoading(MyGuiScreenGamePlay screenToLoad, MyGuiScreenGamePlay screenToUnload, string textureFromConstructor)
            : base(Vector2.Zero, null, null)
        {
            ...
            // SECE
            m_currentLoadingSB = MyTexts.Get(MyCommonTexts.LoadingPleaseWaitUppercase);
        ...
        public CEGuiScreenLoading(MyGuiScreenGamePlay screenToLoad, MyGuiScreenGamePlay screenToUnload)
            : this(screenToLoad, screenToUnload, null)
        {
        }

        // SECE
        public static void SECEUpdateLoadStatus(string newState)
        {
            MySandboxGame.Log.WriteLine(string.Format("CEGuiScreenLoading.SECEUpdateLoadStatus(): {0}",newState));
            if (CEGuiScreenLoading.Static != null)
                CEGuiScreenLoading.Static.SetLoadingText(newState);
        }
        ...
        {
            return "CEGuiScreenLoading";
        }

        public override void LoadContent()
        {
            MySandboxGame.Log.WriteLine("CEGuiScreenLoading.LoadContent - START");
            MySandboxGame.Log.IncreaseIndent();
            VRageRender.MyRenderProxy.GetRenderProfiler().StartProfilingBlock("CEGuiScreenLoading::LoadContent");
            ...
            MySandboxGame.Log.WriteLine("CEGuiScreenLoading.LoadContent - END");
        }
        ...
        {
            VRageRender.MyRenderProxy.GetRenderProfiler().StartProfilingBlock("CEGuiScreenLoading::UnloadContent");
        ...
        public override bool Update(bool hasFocus)
        {
            ...
            VRageRender.MyRenderProxy.GetRenderProfiler().StartProfilingBlock("CEGuiScreenLoading::Update()");
        ...
        private StringBuilder m_currentLoadingSB;
